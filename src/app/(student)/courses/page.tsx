...
import { BookOpen, CheckCircle2, GraduationCap, Play, ArrowRight, Sparkles } from "lucide-react";
import { MOCK_COURSES, COMMERCE_PROGRAMS } from "@/lib/mock-data";
    ...
    <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-300 pb-24 relative">
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-2 text-orange-400 text-xs font-mono mb-1">
          ...
          <span className="tracking-wider uppercase font-bold">PABIR PAUL&apos;S COMMERCE CURRICULUM</span>
        </div>
