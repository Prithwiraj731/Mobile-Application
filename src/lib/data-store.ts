...
export const DEFAULT_COURSES: StoredCourse[] = [
  {
    id: "c-mtodola8-uxi9",
    title: "Financial Accounting & Business Law",
    slug: "bcom-financial-accounting-law",
    code: "BCOM-SEMESTER1",
    program: "BCOM",
    semester: "Semester 1",
    description: "Study materials, ledger templates, and regulatory lecture curriculum for B.COM Semester 1.",
    thumbnail_url: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&auto=format&fit=crop&q=80",
    is_published: true,
    order_index: 1,
    created_at: "2026-09-05T12:47:48.416Z",
    updated_at: "2026-09-05T12:47:48.416Z",
  },
  {
    id: "c-mtoqbywg-zrs0",
    title: "Corporate Accounting & Company Law",
    slug: "corporate-accounting",
    code: "BCOM-SEMESTER2",
    program: "BCOM",
    semester: "Semester 2",
    description: "Study materials, share capital notes, and lecture curriculum for Corporate Accounting.",
    thumbnail_url: "https://images.unsplash.com/photo-1450133064473-71024230f91b?w=600&auto=format&fit=crop&q=80",
    is_published: true,
    order_index: 2,
    created_at: "2026-09-05T18:41:54.544Z",
    updated_at: "2026-09-05T18:41:54.544Z",
  },
];
...
export const DEFAULT_MATERIALS: MaterialWithDetails[] = [
  {
    id: "m-mtr1mv66-ttlr",
    topic_id: "t-1788773631054",
    title: "Business Law - Contract Act Essentials",
    description: "Complete revision breakdown of Section 10 valid contracts.",
    type: "text_note",
    access_level: "free",
    status: "published",
    order_index: 1,
    content_text: "Section 10: All agreements are contracts if they are made by the free consent of parties competent to contract, for a lawful consideration and with a lawful object. Key Elements: 1. Offer and Acceptance, 2. Intention to Create Legal Relationship, 3. Lawful Consideration, 4. Capacity of Parties, 5. Free Consent (Not caused by Coercion, Undue Influence, Fraud, Misrepresentation, or Mistake).",
    created_by_admin_id: "u-admin-master",
    created_at: "2026-09-07T09:33:51.054Z",
    updated_at: "2026-09-07T09:33:51.054Z",
    program: "BCOM",
    semester: "Semester 1",
    topic: {
      id: "t-1788773631054",
      chapter_id: "ch-1788773631054",
      title: "Semester 1",
  ...
  {
    id: "m-mtodola8-qpkf",
    topic_id: "t-1788612468416",
    title: "Financial Accounting - Final Accounts & Depreciation Notes",
    description: "Core accounting concepts, adjustment entries for final accounts, and depreciation methods.",
    type: "text_note",
    access_level: "free",
    status: "published",
    order_index: 2,
    content_text: "Final Accounts Adjustments: 1. Closing Stock (Valued at Cost or Net Realisable Value, whichever is lower), 2. Outstanding Expenses (Add to respective expense in Trading/P&L, show as Current Liability on Balance Sheet), 3. Prepaid Expenses (Deduct from respective expense, show as Current Asset), 4. Provision for Bad Debts (Debit P&L, deduct from Sundry Debtors in Balance Sheet), 5. Depreciation (Straight Line Method vs Written Down Value Method).",
    created_by_admin_id: "u-admin-master",
    created_at: "2026-09-05T12:47:48.416Z",
    updated_at: "2026-09-05T12:47:48.416Z",
    program: "BCOM",
  ...
  {
    id: "m-mtoqbywf-16hp",
    topic_id: "t-1788633714544",
    title: "Corporate Accounting - Issue & Forfeiture of Shares",
    description: "Pro-rata allotment calculation table, journal entries for forfeiture and re-issue of shares.",
    type: "text_note",
    access_level: "pro",
    status: "published",
    order_index: 3,
    content_text: "Issue of Shares at Premium / Par / Discount: 1. Application Money received -> Transferred to Share Capital & Securities Premium. 2. Allotment due -> Received (handle Calls-in-Arrears). 3. Forfeiture of Shares: Share Capital A/c Dr. (Called up amount) To Calls-in-Arrears A/c (Unpaid amount) To Share Forfeiture A/c (Paid amount). 4. Re-issue of Forfeited Shares: Maximum permissible discount on re-issue is the amount forfeited on those shares.",
    created_by_admin_id: "u-admin-master",
    created_at: "2026-09-05T18:41:54.544Z",
    updated_at: "2026-09-05T18:41:54.544Z",
    program: "BCOM",
...
function readData(): AppDataSchema {
  ...
  try {
    ...
    if (!parsed.materials || parsed.materials.length === 0) parsed.materials = [...DEFAULT_MATERIALS];
